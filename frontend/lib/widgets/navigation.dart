  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(children: [
        Row(children: [Image.asset(AppConfig.logo, width: 42, errorBuilder: (_, __, ___) => const Icon(Icons.school_rounded)), const SizedBox(width: 10), const Expanded(child: Text('ExamAI', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w900)))]),
        ...
        SoftCard(padding: const EdgeInsets.all(14), child: Row(children: [const CircleIcon(icon: Icons.auto_awesome_rounded, color: CalmTheme.gold), const SizedBox(width: 10), Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text(user['full_name']?.toString() ?? 'Student', style: const TextStyle(fontWeight: FontWeight.w900)), const SoftText('Live XP badge')]))])),
